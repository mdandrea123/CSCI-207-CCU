...
int main(int argc, char *argv[])
{
    ...
    // Seed the random number generator. I realized this was never genuinely random in previous assignments, so I included
    // time.h and used the time as a seed to make it more random.
    srand(time(NULL)); 
